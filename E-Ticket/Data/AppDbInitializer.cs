            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Cinemas.Any())
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                    {
                        new Cinema()
                        {
                           ...
                           Description = "This is the description of the first cinma"
                        },
                         new Cinema()
                        {
                           Name = "Cinema 2",
                           Logo = "http://dotnethow.net/images/cinemas/cinema-2.jpeg",
                           Description = "This is the description of the second cinma"
                        },
                          new Cinema()
                        {
                           Name = "Cinema 3",
                           Logo = "http://dotnethow.net/images/cinemas/cinema-3.jpeg",
                           Description = "This is the description of the third cinma"
                        },
                           new Cinema()
                        {
                           Name = "Cinema 4",
                           Logo = "http://dotnethow.net/images/cinemas/cinema-4.jpeg",
                           Description = "This is the description of the fourth cinma"
                        },
                            new Cinema()
                        {
                           Name = "Cinema 5",
                           Logo = "http://dotnethow.net/images/cinemas/cinema-5.jpeg",
                           Description = "This is the description of the fifth cinma"
                        }
                    });
                    context.SaveChanges();
                }
                ...
                if (!context.Producers.Any())
                {
                    context.Producers.AddRange(new List<Producer>()
                    {
                        ...
                        {
                          FullName = "Producer 5",
                          Bio = "This is Bio of the fifth producer",
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        new Movie()
                        {
                            ...
                            CinemaId = 4,
                            ProducerId = 4,
                            MovieCategory = MovieCategory.Horrow,
                        },
                        new Movie()
                        {
                            Name = "Race",
